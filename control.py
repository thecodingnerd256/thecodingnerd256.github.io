...
def readme(name, description):
    ...
    f.write(description + "\n\n")
    f.write(
        "Check out the [Demo](https://thecodingnerd256.github.io/" + name + "/).\n\n"
    )
    f.write(
        "Check out the [Docs](https://thecodingnerd256.github.io/"
        + name
        + "/docs/).\n\n"
    )
    f.write("Created using [p5.js](https://p5js.org/)\n\n")
    f.write("## Contact Details\n")
    f.write("__Programmer:__ The Coding Nerd 256 (thecodingnerd256@gmail.com)\n")
    f.write(
    ...
    for line in template:
        ...
        if "/**TITLE**/" in line:
            ...
            newline = line.replace(
                "/**DESCRIPTION**/",
                description
                + ".  This is a project created by The Coding Nerd 256 on "
 ...
 *\t@file sketch.js "
        ...
        + "\n\
 *\n\
 *\t@author The Coding Nerd 256 <thecodingnerd256@gmail.com>\n\
 *\t@version 1.0\n "
        + date_str
        + "\n\
 *\n "
